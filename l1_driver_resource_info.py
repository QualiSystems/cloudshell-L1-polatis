...
'''<ResourceInfo
        ...
        ResourceFamilyName="''' + str(self.family) + '''"
        ResourceModelName="''' + str(self.model) + '''"
...
>
    ...
    <ResourceAttributes>''' + (''.join(
        ...
        <Attribute
            Name="''' + str(attrname) + '''"
            Type="''' + str(self.attrname2typevaluetuple[attrname][0]) + '''"
    ...
    <ResourceMapping><IncomingMapping>''' + str(self.map_path) + '''</IncomingMapping></ResourceMapping>''' if self.map_path else ''
                                ) + '''
</ResourceInfo>
''')
